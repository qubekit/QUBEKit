...
Vendored from the toolkit under the MIT license, see LICENSE-OPENFF

https://raw.githubusercontent.com/openforcefield/openff-toolkit/0.11.0/openff/toolkit/typing/chemistry/environment.py
